...
VALUES ('260f7043-d0bf-4d99-b143-6ee555685561', 'The Wind''s Twelve Quarters', 'Mr. Vannesa Mraz', 25.0, 38),
...
INSERT INTO users(name, surname, email, password, zip_code, phone_number)
    VALUES ('Admin', 'Admin', 'admin@bookverse.lt', '$2a$10$FBByjrD2r.nVxQTd0Nc/cONDD3MtLXi8ozq9PIG7em/4mjgExnRpe', 'LT-0001', '+37060012345'),
            ('User', 'User', 'user@bookverse.lt', '$2a$10$FBByjrD2r.nVxQTd0Nc/cONDD3MtLXi8ozq9PIG7em/4mjgExnRpe', 'LT-0002', '+37060012346');
